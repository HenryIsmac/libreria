...
public class CategoriaController {
	...
	public String add(@RequestParam("idCategoria") @Nullable Integer idCategoria
		...
		if (idCategoria == null) {
			Categoria addCategoria = new Categoria(0, categoria, descripcion);
			categoriaDAO.add(addCategoria);
		} else {
			Categoria upCategoria = new Categoria(idCategoria, categoria, descripcion);
			categoriaDAO.up(upCategoria);
		}
