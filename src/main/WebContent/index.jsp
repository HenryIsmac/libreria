...
<nav class="navbar bg-primary">
		...
		<ul class="nav">
		  ...
		  <li class="nav-item">
		    <a class="nav-link" href="${pageContext.request.contextPath}/categorias/findAll">Categorías</a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-link" href="${pageContext.request.contextPath}/autores/findAll">Autores</a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-link" href="${pageContext.request.contextPath}/libross/findAll">Libros</a>
		  </li>
...
<h1> HOLA MUNDO DESDE TOMCAT!!</h1>
	...
	<footer class="bg-dark text-white text-center py-3">
		<div class="container">
			...
			<p>Desarrollado por <strong>ismac libreria</strong></p>
		</div>
	</footer>
